...
(3, 1, 'neam neam neam', 'neam,smeam,feam', 'neam'),
(4, 1, 'cum este amplasat neam', 'etot,tot,vasea,steopa', 'vasea'),
(5, 1, 'Cum saher maher', 'saher,maher,neam,meam', 'saher'),
(6, 1, 'Culoare neagra in coreeana', 'huni,muni,funi,gek', 'muni');
...
--
ALTER TABLE `comentarii`
  MODIFY `id_coment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `email`
--
ALTER TABLE `email`
  MODIFY `idemail` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `lectii`
--
ALTER TABLE `lectii`
  MODIFY `id_lectii` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
